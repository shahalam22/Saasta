...
export default function PaymentCard() {
  ...
  return (
    <motion.div 
        className='flex flex-col justify-center bg-[#131412] p-10 rounded-lg my-10'
        ref = {ref}
        animate = {controls}
        initial = 'hidden'
    ...
    >
        ...
        <button className='text-xl borde border-4 border-white px-10 py-3 mt-8 hover:border-gray-100 hover:bg-white hover:text-black rounded-[50px]'>Discover More</button>
    </motion.div>
  )
}
